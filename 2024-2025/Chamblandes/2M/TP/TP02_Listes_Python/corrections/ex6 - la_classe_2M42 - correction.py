...
nb_eleves = len(la_classe_de_2M42) 

la_classe_de_2M42_bis.remove("Sara")
la_classe_de_2M42_bis.insert(0, "Sara")

la_classe_de_2M42_sans_Sara.remove("Sara")
en_retenue_bis[2].append("Sara")

la_classe_de_2M42_avec_les_nouveaux.remove("Sara")

for nouveau in les_ptits_nouveaux:
    la_classe_de_2M42_avec_les_nouveaux.append(nouveau)
